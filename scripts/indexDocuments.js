...
const indexClient = new SearchIndexClient(process.env.AZURE_SEARCH_ENDPOINT, new AzureKeyCredential(process.env.AZURE_SEARCH_API_KEY));
const searchClient = new SearchClient(process.env.AZURE_SEARCH_ENDPOINT, INDEX_NAME, new AzureKeyCredential(process.env.AZURE_SEARCH_API_KEY));
